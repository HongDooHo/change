...
public class ThirdWebViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        w = (WebView) findViewById(R.id.fb);
        ws = w.getSettings();
        ...
        w.loadUrl("https://www.facebook.com/fbcameraeffects/tryit/305676600483059/");
    }
}
